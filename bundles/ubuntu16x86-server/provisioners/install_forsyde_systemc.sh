...
# Updated: Kalle Ngo <ugeorge@kth.se> up to SystemC 2.3.1 from 2.3.0
# Date:    2016.09.06
...
#          http://www.accellera.org/downloads/standards/systemc c26b9116f29f1384e21ab8abdb2dd70f
#          register, and download systemc-2.3.1.tgz

#Dfml systemc-2.3.1.tgz a6437844f7961c4e47d9593312f6311c  www.accellera.org/downloads/standards/systemc/accept_license/accepted_download/systemc-2.3.1.tgz
#
###end documentation############################################################
